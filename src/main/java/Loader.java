...
public class Loader {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Parsing duration: " + (System.currentTimeMillis() - startParse) + " ms");

        long startSelectQuery = System.currentTimeMillis();
        DBConnection.customSelect();
        System.out.println("Query duration: " + (System.currentTimeMillis() - startSelectQuery) + " ms");
    }
